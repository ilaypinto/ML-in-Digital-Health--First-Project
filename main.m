...
MW_train_set = create_data_set(folders_train, data, segmentation(1), 'train', label_time, flag_segm_MW, flag_segm_ET);
MW_test_set = create_data_set(folders_test, data, segmentation(1), 'test', label_time, flag_segm_MW, flag_segm_ET);

ET_train_set = create_data_set(folders_train, data, segmentation(2), 'train', label_time, flag_segm_MW, flag_segm_ET);
ET_test_set = create_data_set(folders_test, data, segmentation(2), 'test', label_time, flag_segm_MW, flag_segm_ET);

%% extract features from segmentations - MW & ET
MW_train_feat = create_feat_set(MW_train_set, 'MW_train_feat', flag_feat, labels_tags);
MW_test_feat = create_feat_set(MW_test_set, 'MW_test_feat', flag_feat, labels_tags);

ET_train_feat = create_feat_set(ET_train_set, 'ET_train_feat', flag_feat, labels_tags);
ET_test_feat = create_feat_set(ET_test_set, 'ET_test_feat', flag_feat, labels_tags);
